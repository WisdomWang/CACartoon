...
protocol LBUComicCollecHeaderViewDelegate: class {
    func comicCollectionHeaderView(_ comicCHead: ComicCollectionHeaderView_, moreAction button: UIButton)
}


class ComicCollectionHeaderView_: BaseCollectionReusableView {
