...
//  CACartoon
//
//  Created by Cary on 2019/8/8.
//  Copyright © 2019 Cary. All rights reserved.
//

import UIKit

class ComicHeadCollectionCell:BaseCollectionViewCell {
...
class ComicHeadView: UIView {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(cellType: ComicHeadCollectionCell.self)
    ...
    var detailStatic: LBUComicStaticModel? {
        didSet {
            ...
            bgView.kf.setImage(
                with: URL(string: detailStatic.cover!),
...
extension ComicHeadView: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return themes?.count ?? 0
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(for: indexPath, cellType: ComicHeadCollectionCell.self)
